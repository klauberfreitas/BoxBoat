...
export HEALTH_CHECK_RESOURCE_GROUP="rg-dese-aks"
export RESOURCE_GROUP="rg-dese-aks"
...
az container create --resource-group $RESOURCE_GROUP -l BrazilSouth -n aks-health-check\
